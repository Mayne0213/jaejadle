 ...
 * @returns 완전한 이미지 URL
 */
export function generateOgImageUrl(path: string, baseUrl = 'https://disciples-jaejadle.com'): string {
 ...
 */
export function generateCanonicalUrl(pathname: string, baseUrl = 'https://disciples-jaejadle.com'): string {
